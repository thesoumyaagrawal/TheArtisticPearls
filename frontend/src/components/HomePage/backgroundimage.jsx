...
const backgroundimage = () => {
  return (
    ...
    <div className='content-subheading'><i>  “Embark on a journey through the vibrant strokes & captivating hues of Artistic Pearls, where art is not just created, but crafted with passion & purpose.” </i></div>
    <CustomButton
